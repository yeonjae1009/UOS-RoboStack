...
class Palletizer:
    ...
    def _required_support_ratio(self, dx: float, dy: float, dz: float) -> float:
    ...
    def _candidate_actions_for_box(
        ...
        for dx, dy, dz, rotation in self._orientations(box):
            required_support = self._required_support_ratio(dx, dy, dz)
        ...
        preferred = low_columns or floor_actions or column_actions or actions
