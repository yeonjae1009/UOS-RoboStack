...
EVAL_BOX_SEQ_DIR="${EVAL_BOX_SEQ_DIR:-artifacts/random_spec_eval_10/box_sequence}"
EVAL_SEQUENCE_NAMES="${EVAL_SEQUENCE_NAMES:-random_spec_000 random_spec_001 random_spec_002 random_spec_003 random_spec_004 random_spec_005 random_spec_006 random_spec_007 random_spec_008 random_spec_009}"
